...
Public Class cPreferences
	...
	Property AllowMiscMaterials As Boolean
	Property cmd As SqlCommand


	Private Function LoadPrefs(cmd As SqlCommand) As Boolean
		Try
			...
			Using dt As New DataTable
				...
				If dt.Rows.Count > 0 Then
					...
					AllowMiscMaterials = dtr("Sell_Misc_Items")
				End If
			End Using
			Return True
		Catch ex As Exception
			logger.Error(ex.ToString, "LoadPrefs Error")
			MessageBox.Show(String.Format("Error in LoadPrefs: {0}{1}{2}", Environment.NewLine, Environment.NewLine, ex), "Error")
			Return False
		Finally
		End Try
	End Function
