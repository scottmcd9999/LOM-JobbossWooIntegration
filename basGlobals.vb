...
Module basGlobals
	...
	'Public gucSplash As ucSplash
	'Public gucImport As ucImport
	'Public gucMapping As ucMapping
	Public gucSetup As ucSetup
	Public gucLog As ucLog
	Public gucFile As ucFiles
	Public gucHelp As ucHelp
	'Public gucConfig As ucConfiguration
	'Public gucCFG_General As ucCFG_GeneralOptions
	'Public gucCFG_ColumnMap As ucColumnMapping
	'Public gucCFG_CustMap As ucCustomerMap
	'Public gucCFG_SOMatch As ucSOMatch
	'Public gucCFG_NSO_General As ucNSO_General
	'Public gcUser As cUser
